...
supports XML, CSV and FLR (Fixed Length Record) - for XML it is based on XML Pull.

  XML Pull is a popular stream-based XML API available for android providing an iterator-
