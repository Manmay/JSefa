...
/**
 * Tests to test explicit maps with <code>String</code> keys and elements of different depth.
 * 
 * @author Norman Lahme-Huetig
 */
public class ExplicitMapTypeTest extends TestCase {
    ...
    static final class StringToIntegerMap extends AbstractTestDTO {
        @XmlElementMap(implicit = false, key = @MapKey(name = "key"), values = @MapValue(name = "value"))
