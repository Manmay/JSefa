...
public final class LowLevelSerializationException extends RuntimeException {
    ...
    /**
     * Constructs a new <code>LowLevelSerializationException</code> with the specified detail message and cause.
     * 
     * @param message the detail message
     * @param cause the cause
     */
    public LowLevelSerializationException(String message, Throwable cause) {
        super(message, cause);
    }
