...
public @interface FlrDataType {
    /**
     * The name of the data type. The name must be unique within the set of data types used within one FLR
     * document. If it is not explicitly set it will be generated automatically from the class name.
     */
    String name() default "";

    /**
     * The default prefix of the FLR the annotated class describes. The prefix is used to determine the
